...
#E.
#Create a view called INVOICE that contains all the fields in the invoice below.
CREATE OR REPLACE VIEW INVOICE AS
SELECT s.SALES_ID, d.DATE, c.CUSTOMER_NAME, ad.STREET, ad.CITY, 
ad.COUNTRY, ad.ZIP_CODE, s.SUBTOTAL, s.TAX, s.TOTAL_AMOUNT
FROM sales as s 
